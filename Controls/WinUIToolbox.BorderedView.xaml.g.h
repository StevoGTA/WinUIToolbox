...
namespace winrt::WinUIToolbox::implementation
{
    ...
    struct BorderedViewT : public ::winrt::WinUIToolbox::implementation::BorderedView_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename BorderedViewT::base_type;
        using base_type::base_type;
        using class_type = typename BorderedViewT::class_type;
        ...
        ::winrt::Microsoft::UI::Xaml::Controls::Border mBorder()
        {
            return _mBorder;
        }
        void mBorder(::winrt::Microsoft::UI::Xaml::Controls::Border value)
        {
            _mBorder = value;
        }
    ...
    private:
        struct BorderedView_obj1_Bindings;

        ::winrt::Microsoft::UI::Xaml::Controls::Border _mBorder{nullptr};
    };
}
